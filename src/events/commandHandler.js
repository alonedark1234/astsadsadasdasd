...
module.exports = async (message) => {
  ...
  const embed = new MessageEmbed().setFooter({ text: allah.AltBaşlık}).setColor(message.member.displayHexColor).setAuthor({ name: message.member.displayName, iconURL: message.author.avatarURL({ dynamic: true })});
